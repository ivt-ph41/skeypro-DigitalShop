                            ...
                            <div class="categori-banner">
                                <div class="banner-left">
                                    <div class="banner-image">
                                        <a href="#">
                                            <img src="{{asset('app')}}/img/banner/cms11.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="banner-image">
                                        <a href="#">
                                            <img src="{{asset('app')}}/img/banner/cms12.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="banner-right">
                                    <div class="banner-image">
                                        <a href="#">
                                            <img src="{{asset('app')}}/img/banner/cms13.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="slide-product">
                                    ...
                                    <div class="slide-product-item">
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-summer-dress1.jpg" alt="">
                                                </a>
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress3.jpg" alt="">
                                                </a>
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress5.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                    ...
                                    <div class="slide-product-item">
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress2.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress4.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress6.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                    ...
                                    <div class="slide-product-item">
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress7.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress11.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress10.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                    ...
                                    <div class="slide-product-item">
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress8.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                                        ...
                                        <div class="item3">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product-mini/printed-chiffon-dress12.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="product-info">
                        ...
                        <div class="featured-product w-100">
                            <div class="featured-item">
                                ...
                                <div class="featured-inner">
                                    <div class="featured-image">
                                        <a href="single-product.html">
                                            <img src="{{asset('app')}}/img/product/printed-chiffon-dress4.jpg" alt="">
                                        </a>
                                        <span class="price-percent-reduction">-20%</span>
                                    </div>
                                    <div class="featured-info">
                                ...
                                <div class="row">
                                    <div class="camera-slide featured-product-area">
                                        ...
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress10.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                        ...
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dressw.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                        ...
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress12.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                        ...
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress13.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
            ...
            <div class="popular-tab-categori">
                <div class="container">
                    ...
                    <div id="content" class="tab-menu-slide">
                        <ul id="tabs" class="popular-tab-menu nav nav-tabs" role="tablist">
                            <li class="active">
                        ...
                        <div id="my-tab-content" class="tab-content my-new-tab-content">
                                ...
                                <div class="popular-tab-product featured-product-area">
                                    ...
                                    <div class="tab-single-content">
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress8.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                    ...
                                    <div class="tab-single-content">
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress5.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                    ...
                                    <div class="tab-single-content">
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dress3.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                ...
                                <div class="popular-tab-product featured-product-area">
                                    ...
                                    <div class="tab-single-content">
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dresst.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
                                    ...
                                    <div class="tab-single-content">
                                        <div class="featured-inner">
                                            <div class="featured-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('app')}}/img/product/printed-chiffon-dressac.jpg" alt="">
                                                </a>
                                                <span class="price-percent-reduction">-20%</span>
                                            </div>
                                            <div class="featured-info">
