                                ...
                                <div class="user-info-adn-search">
                                    <div class="user-info">
                                        <p>
                                            ...
                                            <a href="#" id='btn_logout'><i class="fa fa-key"></i> Sign out</a>
                                            ...
                                            <div class="add-to-cart-product">
                                                <div class="cart-product product-item11">
                                                    <div class="cart-product-image">
                                                        <a href="single-product.html"><img src="{{asset('app')}}/img/cart/faded-short-sleeves-tshirt.jpg" alt="Product"></a>
                                                    </div>
                                                ...
                                                <div class="cart-product">
                                                    <div class="cart-product-image">
                                                        <a href="single-product.html"><img src="{{asset('app')}}/img/cart/printed-dress.jpg" alt="Product"></a>
                                                    </div>
                                                    <div class="cart-product-info">
                                                ...
                                                <div class="cart-product">
                                                    <div class="cart-product-image">
                                                        <a href="single-product.html"><img src="{{asset('app')}}/img/cart/printed-summer-dress.jpg" alt="Product"></a>
                                                    </div>
                                                    <div class="cart-product-info">
                                ...
                                <div class="footer-search-area">
                                    ...
                                    <form method="post" action="#">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter your e-mail" size="18" name="email" id="newsletter-input" class="inputNew form-control grey newsletter-input">
                                        </div>
                                    </form>
                                    <div class="hiring">
                                        <div class="img_in"><img alt="icon" src="{{asset('app')}}/img/hire_logo.jpg"></div>
                                        <div class="info">
                                            <h4>we’re hiring!</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="copyright-text">
                                    <p>Copyright &copy; 2019 <a href="http://bootexperts.com/">BootExperts</a>. All rights reserved.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
