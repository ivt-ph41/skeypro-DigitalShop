                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($product->countStock() < 1)
                                 ...
                                 <p><button class='btn-success'>Bấm vào đây nhận thông báo khi shop có hàng</button></p>
                                @else
                                    {{-- Còn hàng --}}
                                    {{-- Số lượng trong kho --}}
                                    <p>Tồn kho: {{ $product->countStock() }} sản phẩm (đã bán {{ $product->countSoldItems() }})</p>
                                    {{-- Phương thức giao --}}
                                    <p>
                                    ...
                                    {{-- Chọn số lượng + đặt hàng --}}
                                        ...
                                        <p>
                                            <button style='width:100%' type='submit' class='btn btn-primary'>THANH TOÁN</button>
                                        </p>
                                    </form>
